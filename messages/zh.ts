...
const zh = {
  ...
  policy: {
    ...
    cancellation: {
      ...
      intro:
        "计划有时会发生变化，我们完全理解。如果需要取消或调整课程时间，请至少在原定上课时间的 2 小时前联系你的老师。",
      ...
      note:
        "如果遇到突发情况，请尽快告诉你的老师。在条件允许的情况下，我们会尽量和你一起找到合适的处理方式。",
    },
    ...
    unexpected: {
      ...
      resolution:
        "Hamkke 会尽量根据实际情况提供合理的解决方式，例如重新安排课程或保留课程次数。",
    ...
    lateArrivals: {
      ...
      noContact:
        "如果课程开始后 10 分钟内仍未进入课堂，并且没有联系你的老师，该节课程将视为未出席，并计为已完成。",
    },
    ...
    repeatedCancellations: {
      ...
      rule:
        "课程取消没有固定的次数限制。我们理解每个人都有可能遇到突发情况。",

      text:
        "不过，如果频繁取消或改期开始影响课程时间的安排，Hamkke 可能会与你沟通目前的固定时间，并一起寻找更合适的安排。",
    ...
    refunds: {
      ...
      note:
        "如果遇到特殊情况，请先联系 Hamkke。我们会尽量和你一起找到公平、合理的解决方式。",
    },
  ...
  inquiry: {
    ...
    success: {
      ...
      message:
        "我们已经收到你的咨询。我们会在 24 小时内回复。很期待进一步了解你的英语情况和学习目标，也一起看看接下来可以怎样继续学习。",
