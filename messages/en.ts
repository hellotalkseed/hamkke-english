...
howItWorks: {
  ...
  audience: {
    ...
    description: "Whether you're learning English to...",

    goals: {
      everyday: {
        title: "Speak more confidently in everyday life",
        text:
          "Express yourself more naturally in conversations, social situations, and everyday interactions.",
      },

      work: {
        title: "Express yourself more clearly at work",
        text:
      ...
      conversation: {
        title: "Feel more comfortable speaking with other people",
        text:
    ...
    closing: {
      lineOne: "The common thread isn't the goal.",
      lineTwo:
  ...
  whatYouWontFindHere: {
    ...
    points: {
      memorizedScripts: {
        ...
        text: "Because real conversations don't follow one.",
      },

      pressure: {
        title: "No pressure to speak perfectly.",
        text: "Because confidence grows through trying.",
      },

      oneSizeFitsAll: {
        title: "No one-size-fits-all lessons.",
        text:
          "Because your goals and challenges are different from someone else's.",
      },

      constantCorrection: {
        title: "No correcting every sentence.",
  ...
  teachingSince: "Teaching English since 2019",
  ...
  headings: {
    experience: "See how I approach English.",
    goals: "Let’s talk about what you want to achieve.",
    stories: "Let’s talk about where you want to go next.",
    startAConversation:
  ...
  reassurance: {
    personalReply: "Personal reply within 24 hours",
    informationSafe: "Your information is safe with me",
  },

  fields: {
    name: "What should I call you?",
    email: "Email address",
    contactMethod: "How should I contact you?",
    contactId: "Your ID, username, or phone number",
    level: "How comfortable are you with English?",
    goal: "What would you like to work on, and why?",
    message:
