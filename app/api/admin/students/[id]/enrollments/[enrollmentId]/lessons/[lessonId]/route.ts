...
export async function PATCH(
   ...
   * ------------------------------------------------------------
   *
   * A lesson credit does not consume the package. Preserve the
   * credited lesson as history, then append one new scheduled
   * lesson after the package's current last date.
   *
   * Explicit "rescheduled" outcomes keep their existing behavior
   * and are NOT auto-rolled.
   */
