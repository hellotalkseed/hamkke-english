...
const en = {
  portal: "Student Portal", loginBrand: "HAMKKE", title: "Your learning, together.",
  introduction: "Your learners, lesson packages, and remaining lessons in one place.",
  loginTitle: "Welcome back.", loginIntro: "Sign in to continue to your account.",
  or: "or", newToHamkke: "New to Hamkke?", enrollmentAccount: "Student accounts are created after your enrollment.", bookAssessment: "Book a Free Assessment",
  ...
  help: "Need help with your password? Please contact Hamkke.",
...
export const portalMessages: Record<Locale, Copy> = {
  en,
  ko: {
    portal: "학생 포털", loginBrand: "HAMKKE", title: "함께 이어가는 영어 여정", introduction: "학습자별 수강 정보와 남은 수업을 한곳에서 확인하세요.",
    loginTitle: "다시 만나 반가워요.", loginIntro: "로그인하여 Hamkke 계정으로 계속하세요.",
    or: "또는", newToHamkke: "Hamkke가 처음이신가요?", enrollmentAccount: "학생 계정은 수강 등록 후 생성됩니다.", bookAssessment: "무료 레벨 상담 예약하기",
    ...
    connection: "계정 정보를 불러오지 못했습니다. 다시 시도해 주세요.", help: "비밀번호 관련 도움이 필요하신가요? Hamkke에 문의해 주세요.",
  ...
  zh: {
    portal: "学员中心", loginBrand: "HAMKKE", title: "一起走过的学习旅程", introduction: "在这里查看学员信息、课程套餐和剩余课时。",
    loginTitle: "欢迎回来。", loginIntro: "登录以继续使用您的 Hamkke 账号。", or: "或", newToHamkke: "第一次来到 Hamkke？", enrollmentAccount: "学员账号将在完成报名后创建。", bookAssessment: "预约免费评估", email: "电子邮箱", password: "密码", signIn: "登录", signingIn: "正在登录…", signOut: "退出登录", home: "首页", language: "语言", learners: "学员",
    credentials: "登录失败。请检查邮箱和密码后重试。", unavailable: "此账号暂时无法使用学员中心。请联系 Hamkke。", connection: "无法加载账号信息，请重试。", help: "需要密码帮助？请联系 Hamkke。",
  ...
  ja: {
    portal: "受講者ポータル", loginBrand: "HAMKKE", title: "一緒に歩む、英語の学び。", introduction: "受講者ごとのコース情報と残りのレッスン数を確認できます。",
    loginTitle: "おかえりなさい。", loginIntro: "ログインして Hamkke アカウントに進んでください。", or: "または", newToHamkke: "Hamkkeは初めてですか？", enrollmentAccount: "受講者アカウントは受講登録後に作成されます。", bookAssessment: "無料アセスメントを予約する", email: "メールアドレス", password: "パスワード", signIn: "ログイン", signingIn: "ログイン中…", signOut: "ログアウト", home: "ホーム", language: "言語", learners: "受講者",
    credentials: "ログインできませんでした。メールアドレスとパスワードを確認して、もう一度お試しください。", unavailable: "このアカウントではポータルを利用できません。Hamkkeにお問い合わせください。", connection: "アカウント情報を読み込めませんでした。もう一度お試しください。", help: "パスワードについてお困りの場合は、Hamkkeにお問い合わせください。",
